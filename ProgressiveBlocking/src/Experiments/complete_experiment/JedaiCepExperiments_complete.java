...
import DataStructures.WComparison;
...
public class JedaiCepExperiments_complete {
    ...
    public static void main(String[] args) {
        ...
        for (int dataset : DATASETS) {
            ...
            List<org.scify.jedai.datamodel.EntityProfile> profiles1;
            List<EntityProfile> profiles2;

            //List<EntityProfile>[] profiles;
            AbstractDuplicatePropagation adp;
            org.scify.jedai.utilities.datastructures.AbstractDuplicatePropagation adp_tmp;

            Instant start = Instant.now();
            Instant t_init = Instant.now();

            profiles1 = JedaiUtilities.getEntities(0, true);
            profiles2 = JedaiUtilities.getEntities(1, true);
...
//                }
            ...
            /*HashSet<WComparison> comp = new HashSet<>();*/
                ...
                while (pm.hasNext()) {
                    ...
                    WComparison next = (WComparison) pm.next();
                    if (next != null) {
